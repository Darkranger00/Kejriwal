...
import sarkar.modules.sql.global_bans_sql as sql
from sarkar.modules.sql.users_sql import get_user_com_chats
from sarkar import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from sarkar.modules.helper_funcs.misc import send_to_list
