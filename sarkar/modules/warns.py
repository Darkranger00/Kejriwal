...
import telegram
from sarkar import TIGERS, WOLVES, dispatcher
from sarkar.modules.disable import DisableAbleCommandHandler
from sarkar.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from sarkar.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from sarkar.modules.helper_funcs.string_handling import split_quotes
from sarkar.modules.log_channel import loggable
from sarkar.modules.sql import warns_sql as sql
